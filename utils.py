...
def acc_and_f1_test(preds, labels, average="macro"):
    ...
    precision = precision_score(labels, preds, labels=[1,2,3,4], average='macro')
    recall = recall_score(labels, preds, labels=[1,2,3,4], average='macro')
    m_f=2*(precision*recall)/(precision+recall)
    precision_mi = precision_score(labels, preds, labels=[1,2,3,4],average='micro')
    recall_mi = recall_score(labels, preds, labels=[1,2,3,4],average='micro')
    # f1 = f1_score(y_true=labels, y_pred=preds, labels=[1, 2, 3, 4], average=average)
    f1 = f1_score(y_true=labels, y_pred=preds,labels=[1,2,3,4], average=average)
    f1_mi = f1_score(y_true=labels, y_pred=preds,labels=[1,2,3,4],  average="micro")
    ...
    report=sm.classification_report(y_true=labels, y_pred=preds, target_names=target_names, digits=5)
    print(report)
    # 画出混淆矩阵
